            ...
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-lg-5 col-md-6 col-12" data-cue="slideInLeft">
                     <div data-cue="fadeIn">
                        <small class="text-primary text-uppercase ls-md fw-semibold">Our Mission</small>
                        <div class="mb-5 mt-4">
            ...
            <div class="container pb-lg-5">
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-5 offset-lg-1 col-md-6 col-12 order-lg-2" data-cue="slideInRight">
                     <div class="mt-md-5">
                        <small class="text-primary text-uppercase ls-md fw-semibold">What We Do</small>
                        <div class="mb-5 mt-4">
            ...
            <div class="container">
               ...
               <div class="row g-lg-7 gy-5">
                  ...
                  <div class="col-lg-4 col-md-4">
                     ...
                     <p>MEG to be a preferred entity noted for environmental and safety friendly practices with respect to the MDG goal 7, ensuring environmental sustainability.</p>
