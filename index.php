                ...
                <div class="d-flex flex-column gap-6">
                    <div class="d-flex flex-column gap-4">
                        ...
                        <p class="mb-0 text-white-50 lead px-lg-10">
                            Empowering Global Ventures in Exploration, Mining, and Gold Trading with M. Enterprise Ghana
                            Limited
                        </p>
                    </div>
                    <div class="d-md-flex d-grid align-items-center justify-content-md-center gap-4">
                        ...
                        <a href="<?= PROOT; ?>projects"
                            class="link-white icon-link icon-link-hover card-grid-link d-flex justify-content-center">
                            Recent Projects
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3" data-cue="fadeIn">
                <div class="text-center mb-xl-7 mb-5">
                    ...
                    <p class="mb-0">At least, not exclusively. Reduced recruiting costs, more efficient and effective
                        communication.</p>
                </div>
            </div>
        </div>
                    ...
                    <article class="col-lg-4 col-md-6 col-12" data-cue="zoomIn">
                        <figure class="mb-4 zoom-img">
                            <a href="post?slug=<?= sanitize($post['slug']) ?>">
                                <img src="<?= PROOT; ?>assets/media/blog/<?= sanitize($post['image'] ?: 'placeholder.jpg') ?>"
                                    alt="<?= sanitize($post['title']) ?>" class="img-fluid rounded-3" />
                            </a>
                        </figure>

                        <a href="#!"
                            class="badge bg-primary-subtle text-primary-emphasis rounded-pill text-uppercase"><?= sanitize($post['category_name'] ?? 'Uncategorized') ?></a>
                        <h3 class="my-3 lh-base h4">
                            <a href="post?slug=<?= sanitize($post['slug']) ?>"
                                class="text-reset"><?= sanitize($post['title']) ?></a>
                        </h3>
                        <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                            <div class="d-flex align-items-center">
                                <img src="<?= PROOT; ?>assets/media/avatar.png" alt="Avatar"
...
<section class="py-xl-9 py-5" data-cue="fadeIn">
    <div class="container">
        ...
        <h2 class="mb-4">We provide expert consultancy in exploration, mining as well as Gold trading within Ghana and
            beyond. We have established ourselves strategically to assist mining groups around the globe with practical
            skill to improve the mining industry. <br>We provide consultancy services into four (4) thematic areas.</h2>
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row g-4">
            <div class="col-xl-5 col-lg-6 col-12" data-cue="slideInLeft">
                <div class="mb-4">
                    ...
                    <p class="mb-3">under the government of Ghana Act 1962(N0. 151). We provide expert consultancy in
                        exploration, mining as well as Gold trading within Ghana and beyond</p>
                    <p class="mb-4">We have established ourselves strategically to assist mining groups around the globe
                        with practical skill to improve the mining industry.</p>

                    <h4 class="mt-4 mb-2">Our Vision</h4>
                    <p class="mb-4">To become the world's most trusted exploration, mining, and gold trading
                        consultancy, recognized for excellence, innovation, integrity, and outstanding service to every
                        client and stakeholder.</p>

                    <h4 class="mt-4 mb-2">Our Mission</h4>
                    <p class="mb-0">To simplify the acquisition of precious metals for buyers while promoting
                        environmental sustainability and regulatory compliance.</p>
                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <a href="#!">
                            <div class="rounded-3 card-lift"
                                style="background-image: url(<?= PROOT; ?>assets/media/back-2.jpeg); background-repeat: no-repeat; height: 386px; background-size: cover">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                        <a href="#!">
                            <div class="mb-4 rounded-3 card-lift"
                                style="background-image: url(<?= PROOT; ?>assets/media/back-1.jpeg); background-repeat: no-repeat; height: 180px; background-size: cover">
                            </div>
                        </a>
                        <a href="#!">
                            <div class="mb-2 rounded-3 card-lift"
                                style="background-image: url(<?= PROOT; ?>assets/media/back-3.jpg); background-repeat: no-repeat; height: 180px; background-size: cover">
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="row border-top border-bottom">
                ...
                <div class="text-center py-lg-5 p-4">
                    <div class="mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                            class="bi bi-people-fill text-warning" viewBox="0 0 16 16">
                            <path
            ...
            <div class="col-md-4 border-end-md border-bottom border-bottom-md-0" data-cue="zoomIn">
                <div class="text-center py-lg-5 p-4">
                    <div class="mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                            class="bi bi-trophy-fill text-warning" viewBox="0 0 16 16">
                            <path
            ...
            <div class="col-md-4" data-cue="zoomIn">
                <div class="text-center py-lg-5 p-4">
                    <div class="mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                            class="bi bi-stars text-warning" viewBox="0 0 16 16">
                            <path
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="card shadow-sm" data-cue="slideInLeft">
                    <div class="card-body">
                        <p class="mb-5 lead">
                            “As a mining engineer, I had a fantastic experience working with M. Enterprise Ghana
                            Limited. Their team of experts provided exceptional consultancy services, guiding us with
                            their extensive knowledge and practical skills.”
                        </p>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="card shadow-sm" data-cue="slideInRight">
                    <div class="card-body">
                        <p class="mb-5 lead">
                            "As a geologist, I can confidently say that MEG has been instrumental in our gold
                            exploration endeavors. Their consultancy services have been invaluable in helping us
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="card shadow-sm" data-cue="slideInRight">
                    <div class="card-body">
                        <p class="mb-5 lead">
                            "As a gold trader, MEG stands out as a trusted partner in the gold trading industry. Their
                            expertise and extensive network have facilitated smooth transactions, allowing us to expand
                            our business."
                        </p>
                        <div class="d-md-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center mb-3 mb-lg-0">
                    ...
                    <div class="swiper-wrapper pb-6">
                        <div class="swiper-slide">
                            <figure class="text-center">
                                <img src="<?= PROOT; ?>assets/media/client-01.png" class="img-fluid" width="100"
                                    alt="logo" />
                            </figure>
                        </div>
                        <div class="swiper-slide">
                            <figure class="text-center">
                                <img src="<?= PROOT; ?>assets/media/client-02.png" class="img-fluid" width="100"
                                    alt="logo" />
                            </figure>
                        </div>
                        <div class="swiper-slide">
                            <figure class="text-center">
                                <img src="<?= PROOT; ?>assets/media/client-03.png" class="img-fluid" width="100"
                                    alt="logo" />
                            </figure>
                        </div>
                        <div class="swiper-slide">
                            <figure class="text-center">
                                <img src="<?= PROOT; ?>assets/media/client-04.png" class="img-fluid" width="100"
                                    alt="logo" />
                            </figure>
                        </div>
                        <div class="swiper-slide">
