        ...
        <div class="container">
            ...
            <div class="row" id="ft-links">
                <div class="col">
                    ...
                    <div class="collapse d-lg-block" id="collapseResources" data-bs-parent="#ft-links">
                        <ul class="list-unstyled mb-0 py-3 py-lg-0">
                            <li class="mb-2">
                                <a href="./docs/index.html" class="text-decoration-none text-reset">Permits</a>
                            </li>
                            <li class="mb-2">
                                <a href="#!" class="text-decoration-none text-reset">Land Reclamation Project</a>
                            </li>
                            <li class="mb-2">
                                <a href="#!" class="text-decoration-none text-reset">All Project</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col">
                    ...
                    <ul class="list-unstyled mb-0 py-3 py-lg-0">
                        <li class="mb-2">
                            <a href="./docs/index.html" class="text-decoration-none text-reset">About us</a>
                        </li>
                        <li class="mb-2">
                            <a href="#!" class="text-decoration-none text-reset">Contact us</a>
                        </li>
                        <li class="mb-2">
                            <a href="./changelog.html" class="text-decoration-none text-reset">News</a>
                        </li>
                        <li class="mb-2">
                ...
                <div class="col">
                    ...
                    <div class="collapse d-lg-block" id="collapseCommunity" data-bs-parent="#ft-links">
                        <ul class="list-unstyled mb-0 py-3 py-lg-0">
                            <li class="mb-2">
                                <a href="./docs/index.html" class="text-decoration-none text-reset">Support</a>
                            </li>
                            <li class="mb-2">
                                <a href="#!" class="text-decoration-none text-reset">info@email.com</a>
                            </li>
                            <li class="mb-2">
                                <a href="./changelog.html" class="text-decoration-none text-reset">caareer@email.com</a>
                            </li>
                            <li class="mb-2">
